...
MODEL_PATH = "./radiounet_baseline_run/radiounet_baseline_best.keras"
SAVE_DIR = "./radiounet_baseline_inference"
...
def main():
    ...
    for global_idx, (map_ind, tx_idx) in enumerate(test_refs):
        x, label_norm = load_one_sample(map_ind, tx_idx)
        pred_norm = model.predict(x[None, ...], verbose=0)[0, ..., 0]
    ...
    print("====== RadioUNet Baseline Test Results ======")
