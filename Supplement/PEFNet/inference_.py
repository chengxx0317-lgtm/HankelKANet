...
def main():
    ...
    # FIXED_VIS_INDICES = [218, 518, 666, 707, 1283, 1313, 4789, 5942, 6807, 6960]
    vis_samples = {"87_17", "99_42", "102_6", "121_55", "138_3", "156_29", "166_45", "189_26","379_33","387_53",
                   ...
                   "561_34", "561_42", "561_47","561_51", "561_56", "561_67"}  # 你自己挑

    # vis_indices = set(FIXED_VIS_INDICES)
    ...
    rmse_db_list = []
    r2_list = []
    preds_all = []   # only used if SAVE_FULL_OUTPUT = True
    labels_all = []
        ...
        for batch_idx, (inputs, label, E_inc_raw,sample_ids ) in enumerate(test_loader):
            ...
            for i in range(B):
                if global_idx in vis_indices:
                    ...
                    plt.tight_layout()
                    plt.savefig(
                        os.path.join(vis_dir, f"sample_{global_idx:05d}.png")
                    )
                    plt.close(fig)
